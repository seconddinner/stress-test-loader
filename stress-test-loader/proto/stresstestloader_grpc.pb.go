...
const (
	StressTestLoader_StartStressTest_FullMethodName     = "/stresstestloader.StressTestLoader/StartStressTest"
	StressTestLoader_StopStressTest_FullMethodName      = "/stresstestloader.StressTestLoader/StopStressTest"
	StressTestLoader_GetStressTestStatus_FullMethodName = "/stresstestloader.StressTestLoader/GetStressTestStatus"
)
...
func (c *stressTestLoaderClient) StartStressTest(ctx context.Context, in *TestRequest, opts ...grpc.CallOption) (*TestReply, error) {
	out := new(TestReply)
	err := c.cc.Invoke(ctx, StressTestLoader_StartStressTest_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stressTestLoaderClient) StopStressTest(ctx context.Context, in *TestRequest, opts ...grpc.CallOption) (*TestReply, error) {
	out := new(TestReply)
	err := c.cc.Invoke(ctx, StressTestLoader_StopStressTest_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stressTestLoaderClient) GetStressTestStatus(ctx context.Context, in *TestRequest, opts ...grpc.CallOption) (*TestReply, error) {
	out := new(TestReply)
	err := c.cc.Invoke(ctx, StressTestLoader_GetStressTestStatus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _StressTestLoader_StartStressTest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StressTestLoader_StartStressTest_FullMethodName,
	}
...
func _StressTestLoader_StopStressTest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StressTestLoader_StopStressTest_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _StressTestLoader_GetStressTestStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StressTestLoader_GetStressTestStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var StressTestLoader_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "stresstestloader.proto",
}
